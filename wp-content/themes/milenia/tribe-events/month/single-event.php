...
<div id="tribe-events-event-<?php echo esc_attr( $event_id ); ?>" class="<?php tribe_events_event_classes() ?> milenia-events-event" data-tribejson='<?php echo esc_attr( tribe_events_template_data( $post ) ); ?>'>
	<h3 class="milenia-events-month-event-title"><a href="<?php echo esc_url( $link ) ?>" class="milenia-ln--independent url"><?php echo esc_html($title); ?></a></h3>
