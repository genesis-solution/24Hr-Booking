			...
			<div class="milenia-aligner-inner">
				<header class="milenia-entity-header">
					...
					<div class="milenia-entity-meta">
                        <div class="milenia-entity-labels">
                            <span class="milenia-entity-label"><?php esc_html_e('Featured', 'milenia'); ?></span>
                        </div>
				...
				<footer class="milenia-entity-footer">
					...
					<div class="milenia-entity-extra-actions">
						...
						<a href="<?php echo esc_url(tribe_get_map_link()); ?>" class="milenia-ln--independent milenia-icon-btn">
