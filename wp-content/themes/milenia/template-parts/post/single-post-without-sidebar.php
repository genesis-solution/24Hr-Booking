	...
	<?php while(have_posts()) : the_post(); ?>
        ...
        <div class="milenia-single-entity-container">
            ...
            <div class="milenia-section">
                <main <?php post_class('milenia-entity-single milenia-entity--post milenia-entity--style-2 milenia-form--fields-white'); ?>>
                    <!-- - - - - - - - - - - - - - Post Header - - - - - - - - - - - - - -->
			...
			<?php if(($milenia_share_buttons_state == 'show' || $milenia_share_buttons_state == '1') && isset($milenia_post_cats_final) && !empty($milenia_post_cats_final) && shortcode_exists('vc_milenia_blog_posts')) : ?>
				...
				<section class="milenia-section">
					...
					<?php echo do_shortcode(sprintf('[vc_milenia_blog_posts milenia_blog_posts_data_exclude="%s" milenia_blog_posts_data_categories="%s" milenia_blog_posts_data_total_items="3" milenia_blog_posts_columns="milenia-grid--cols-3" milenia_blog_posts_style="milenia-entities--style-7" milenia_blog_posts_no_content_state="true" milenia_blog_posts_no_read_more_btn_state="true" milenia_reduce_bq_characters="true"]', get_the_ID(), implode(',', $milenia_post_cats_final))); ?>
				</section>
				<!-- - - - - - - - - - - - - - End of Content Section - - - - - - - - - - - - - -->
			<?php endif; ?>
