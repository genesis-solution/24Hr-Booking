<?php
/**
* The slideshow layout for the single project page.
*
* @package WordPress
* @subpackage Milenia
* @since Milenia 1.0
...
<?php if(isset($milenia_project_gallery['sliders']) && isset($milenia_project_gallery['sliders']['slides']) && is_array($milenia_project_gallery['sliders']['slides']) && count($milenia_project_gallery['sliders']['slides'])) : ?>
    ...
    <div class="milenia-entity-media">
        <div class="owl-carousel milenia-simple-slideshow">
            <?php foreach($milenia_project_gallery['sliders']['slides'] as $image) : ?>
                <?php echo wp_get_attachment_image($image['attach_id'], 'entity-thumb-standard', false, array(
 ...
 * @hooked
 */
do_action('milenia_single_post_after_content', get_post(), true);
?>
