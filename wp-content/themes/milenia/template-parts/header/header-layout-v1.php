<?php
/**
* The template file that describes header v1.
*
* @package WordPress
* @subpackage Milenia
* @since Milenia 1.0
...
$milenia_header_top_bar_state = $Milenia->getThemeOption('milenia-header-top-bar', '0', array(
...
<header id="milenia-header" class="milenia-header <?php echo esc_attr($MileniaHelper->getSanitizedHtmlClasses($milenia_header_classes)); ?>">
	<!--================ Section ================-->
	<div class="milenia-header-section-lg milenia-header-section--columns-border milenia-header-section--has-navigation <?php echo esc_attr($MileniaHelper->getSanitizedHtmlClasses($milenia_main_section_classes)); ?>">
		<!--================ Column ================-->
				...
				<div class="milenia-aligner-inner">
					...
					<div class="milenia-header-section-xl milenia-header-section--has-navigation">
						...
						<?php if(!empty($milenia_header_right_col_elements)) : ?>
							<!--================ Column ================-->
							<div class="milenia-header-col milenia-header-col-xl-4 milenia-aligner milenia-aligner--valign-middle milenia-header-col--content-align-right-xl milenia-header-col--padding-no-y <?php echo esc_attr($MileniaHelper->getSanitizedHtmlClasses($milenia_right_col_classes)); ?>">
								<div class="milenia-aligner-outer">
									<div class="milenia-aligner-inner">
										<div class="milenia-header-items">
