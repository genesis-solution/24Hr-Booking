<?php
/**
* The template file that describes header v3.
*
* @package WordPress
* @subpackage Milenia
* @since Milenia 1.0
...
$milenia_header_color_scheme = $Milenia->getThemeOption('milenia-header-color-scheme', 'milenia-header--dark', array(
...
$milenia_header_left_col_elements = $Milenia->getThemeOption('milenia-header-left-column-elements', array('menu-btn', 'languages', 'weather'), array(
...
<header id="milenia-header" class="milenia-header <?php echo esc_attr($MileniaHelper->getSanitizedHtmlClasses($milenia_header_classes)); ?>">
    <!--================ Section ================-->
    <div class="milenia-header-section-xxxl milenia-header-section--has-navigation <?php echo esc_attr($MileniaHelper->getSanitizedHtmlClasses($milenia_main_section_classes)); ?>">
        <!--================ Column ================-->
        <div class="milenia-header-col milenia-header-col--light milenia-header-col-xxxl-logo milenia-aligner milenia-aligner--valign-middle milenia-header-col--padding-small milenia-header-col--padding-no-x">
        ...
        <!--================ Column ================-->
        <div class="milenia-header-col milenia-aligner milenia-aligner--valign-middle milenia-header-col--padding-no">
            <div class="milenia-aligner-outer">
                <div class="milenia-aligner-inner">
                    <!--================ Section ================-->
                    <div class="milenia-header-section-xxl">
                        <!--================ Column ================-->
                        <div class="milenia-header-col milenia-header-col-xxl-3 milenia-header-col--content-align-left-xxl milenia-aligner milenia-aligner--valign-middle milenia-header-col--padding-default milenia-header-col--padding-no-y-xxl">
                            <div class="milenia-aligner-outer">
                                <div class="milenia-aligner-inner">
                                    <div class="milenia-header-items">
                        ...
                        <!--================ End of Column ================-->
                        <!--================ Column ================-->
                        <div class="milenia-header-col milenia-aligner milenia-aligner--valign-middle milenia-header-col--content-align-right-xxl milenia-header-col--padding-no">
                            <div class="milenia-aligner-outer">
                                <div class="milenia-aligner-inner">
                                    <div class="milenia-header-items">
										<?php echo do_shortcode('[vc_milenia_booking_form style="milenia-booking-form-wrapper--v3" scheme="milenia-booking-form-wrapper--light"][/vc_milenia_booking_form]'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
