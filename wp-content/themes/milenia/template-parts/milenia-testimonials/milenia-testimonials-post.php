...
<div <?php post_class('milenia-grid-item') ?>>
	...
	<div class="milenia-testimonial">
		...
		<blockquote aria-labelledby="testimonial-cite-<?php echo esc_attr(get_the_ID()); ?>" class="milenia-blockquote--unstyled milenia-text-color--darkest" <?php if(!empty($milenia_t_color)) : ?>style="color: <?php echo esc_attr($milenia_t_color); ?>;"<?php endif; ?>>
			<?php the_content(); ?>
		</blockquote>
		<footer class="milenia-author<?php if($milenia_t_style == 'milenia-testimonials--style-3') : ?> milenia-author--style-2<?php endif; ?>">
			...
			<div class="milenia-author-info">
				<cite id="testimonial-cite-<?php echo esc_attr(get_the_ID()); ?>" <?php if(!empty($milenia_t_author_name_color)) : ?>style="color: <?php echo esc_attr($milenia_t_author_name_color); ?>;"<?php endif; ?>>
