...
";
        ...
        if ($this->extensions['MailPoet\Twig\Analytics']->isEnabled()) {
            // line 183
            echo "  ";
            $this->loadTemplate("analytics.html", "layout.html", 183)->display($context);
        }
        // line 185
        echo "
";
