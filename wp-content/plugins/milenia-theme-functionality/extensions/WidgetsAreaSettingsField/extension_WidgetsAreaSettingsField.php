...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_Extension_WidgetsGeometryField' ) ) {
    /**
     * Main ReduxFramework custom_field extension class
     *
     * @since       3.1.6
     */
    class ReduxFramework_Extension_WidgetsAreaSettingsField {
        ...
        public $min_redux_version    = '3.6.11';
        // Protected vars
        protected $parent;
        ...
        */
        public function __construct( $parent ) {
            ...
            $this->field_name = 'widgets_area_settings';
