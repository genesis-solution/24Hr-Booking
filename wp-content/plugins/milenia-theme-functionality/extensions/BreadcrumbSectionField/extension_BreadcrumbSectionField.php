...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_Extension_BreadcrumbSectionField' ) )
{
    /**
     ...
     * @since       3.1.6
     */
    class ReduxFramework_Extension_BreadcrumbSectionField
    {

        // Set the version number of your extension here
        public static $version       = '1.0.0';
        // Set the name of your extension here
        public $ext_name             = 'Breadcrumb section';
        ...
        */
        public function __construct( $parent ) {
            ...
            $this->field_name = 'breadcrumb_section';
