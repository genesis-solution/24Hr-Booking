...
class PortfolioShortcode extends VisualComposerExtensionShortcodeBase implements VisualComposerShortcodeInterface
{
    /**
    ...
    public function getParams()
    {
        return array(
            ...
            'base' => 'vc_milenia_portfolio',
            'category' => esc_html__('Milenia', 'milenia-app-textdomain'),
            'description' => esc_html__('Shows portfolio projects.', 'milenia-app-textdomain'),
            'params' => array(
                array(
                    'type' => 'dropdown',
                    'heading' => esc_html__('Item style', 'milenia-app-textdomain'),
                    'param_name' => 'milenia_portfolio_item_style',
                    'value' => array(
                        esc_html__('Style 1', 'milenia-app-textdomain') => 'milenia-entities--style-18',
                        esc_html__('Style 2', 'milenia-app-textdomain') => 'milenia-entities--style-17'
                    ),
                ...
                array(
                    ...
                    'param_name' => 'milenia_portfolio_layout',
                    'value' => array(
                ...
                array(
                    ...
                    'param_name' => 'milenia_portfolio_columns',
                    'value' => array(
                ...
                array(
                    ...
                    'param_name' => 'milenia_portfolio_filter_state',
                    'value' => 0,
                    'admin_label' => false
                ),
                array(
                    ...
                    'param_name' => 'milenia_portfolio_categories_state',
                    'value' => 0,
                    'admin_label' => false
                ),
                array(
                    ...
                    'param_name' => 'milenia_portfolio_filter_default_title',
                    ...
                    'dependency' => array(
                        'element' => 'milenia_portfolio_filter_state',
                        'not_empty' => true
                    )
                ),
                array(
                    ...
                    'param_name' => 'milenia_portfolio_data_total_items',
                    'value' => 6,
                ...
                array(
                    ...
                    'param_name' => 'milenia_portfolio_data_order_by',
                    'value' => array(
                ...
                array(
                    ...
                    'param_name' => 'milenia_portfolio_data_sort_order',
                    'value' => array(
                ...
                array(
                    ...
                    'param_name' => 'milenia_portfolio_data_offset',
                ...
                array(
                    "type" => 'get_terms',
                    "term" => 'milenia-portfolio-categories',
                    'heading' => esc_html__( 'Categories', 'milenia-app-textdomain' ),
                    'param_name' => 'milenia_portfolio_data_categories',
                ...
                array(
                    'type' => 'get_posts',
                    'post_type' => 'milenia-portfolio',
                    'heading' => esc_html__( 'Include', 'milenia-app-textdomain' ),
                    'param_name' => 'milenia_portfolio_data_inc',
                ...
                array(
                    ...
                    'param_name' => 'milenia_portfolio_data_exc',
    ...
    {
        add_shortcode('vc_milenia_portfolio', array($this, 'content'));
    }
    ...
    public function content($atts, $content = null)
    {
        $this->attributes = shortcode_atts( array(
			'milenia_portfolio_item_style' => 'milenia-entities--style-18',
			'milenia_portfolio_layout' => 'grid',
			'milenia_portfolio_columns' => 'milenia-grid--cols-4',
			'milenia_portfolio_data_total_items' => 6,
			'milenia_portfolio_data_order_by' => 'date',
			'milenia_portfolio_data_sort_order' => 'DESC',
			'milenia_portfolio_data_offset' => 0,
			'milenia_portfolio_data_categories' => '',
			'milenia_portfolio_data_tags' => '',
			'milenia_portfolio_data_inc' => '',
			'milenia_portfolio_data_exc' => '',
			'milenia_portfolio_categories_state' => 0,
			'milenia_portfolio_filter_state' => 0,
			'milenia_portfolio_filter_default_title' => esc_html__('All', 'milenia-app-textdomain'),
			'css_animation' => 'none',
			'milenia_extra_class_name' => ''
		), $atts, 'vc_milenia_portfolio' );

		$this->unique_filter_id = self::getShortcodeUniqueId('vc-portfolio-filter');
		$this->unique_container_id = self::getShortcodeUniqueId('vc-portfolio-container');

		// Sanitization of the attributes
		$item_style = $this->throughWhiteList($this->attributes['milenia_portfolio_item_style'], array( 'milenia-entities--style-18', 'milenia-entities--style-17' ), 'milenia-entities--style-18');
		$this->layout = $this->throughWhiteList($this->attributes['milenia_portfolio_layout'], array( 'grid', 'masonry' ), 'grid');
		$columns = $this->throughWhiteList($this->attributes['milenia_portfolio_columns'], array( 'milenia-grid--cols-1', 'milenia-grid--cols-2', 'milenia-grid--cols-3', 'milenia-grid--cols-4' ), 'milenia-grid--cols-3');
		$total_items = is_numeric($this->attributes['milenia_portfolio_data_total_items']) ? intval($this->attributes['milenia_portfolio_data_total_items']) : 6;
		...
		if(boolval($this->attributes['milenia_portfolio_categories_state'])) {
		...
		return $this->prepareShortcodeTemplate( self::loadShortcodeTemplate('vc-milenia-portfolio-container.tpl'), array(
			'${items}' => $this->getItems(),
			'${filter}' => ((bool) $this->attributes['milenia_portfolio_filter_state']) ? $this->getFilter() : '',
	...
	protected function getItems()
	{
		...
		// Sanitization of the attributes
		$total_items = is_numeric($this->attributes['milenia_portfolio_data_total_items']) ? intval($this->attributes['milenia_portfolio_data_total_items']) : 6;
		$offset = is_numeric($this->attributes['milenia_portfolio_data_offset']) ? intval($this->attributes['milenia_portfolio_data_offset']) : 0;
		$order_by = $this->throughWhiteList($this->attributes['milenia_portfolio_data_order_by'], array('date', 'title', 'id', 'rand'), 'date');
		$order = $this->throughWhiteList($this->attributes['milenia_portfolio_data_sort_order'], array('DESC', 'ASC'), 'DESC');
		...
		if(!empty($this->attributes['milenia_portfolio_data_inc']) && $this->attributes['milenia_portfolio_data_inc'] != 'none') {
			$query_args[strrev('edulcni')] = str_replace(' ', '', $this->attributes['milenia_portfolio_data_inc']);
		}

		if(!empty($this->attributes['milenia_portfolio_data_exc']) && $this->attributes['milenia_portfolio_data_exc'] != 'none') {
			$query_args['exclude'] = str_replace(' ', '', $this->attributes['milenia_portfolio_data_exc']);
		}

		if(!empty($this->attributes['milenia_portfolio_data_categories']) && $this->attributes['milenia_portfolio_data_categories'] != 'none') {
			$query_args['tax_query'] = array(
                array(
                    'taxonomy' => 'milenia-portfolio-categories',
                    'field' => 'term_id',
                    'terms' => explode(',', str_replace(' ', '', $this->attributes['milenia_portfolio_data_categories'])),
		...
		foreach($posts as $index => $post) {
			...
			{
				if($index != 0 && ($index % 5 == 0 || ($index+1) % 7 == 0))
				{
		...
		?>
				...
				<?php require('templates/vc-milenia-portfolio-item.php'); ?>
			<?php

			$post_categories = get_the_terms(get_the_ID(), 'milenia-portfolio-categories');
	...
	{
		$filter_items = sprintf('<li><a href="#" class="milenia-active" data-filter="%s">%s</a></li>', '*', esc_html($this->attributes['milenia_portfolio_filter_default_title']));
	...
	{
		return sprintf('<li><a href="#" data-filter="%s">%s</a></li>', '.milenia-portfolio-categories-' . esc_attr($item->slug), esc_html(ucfirst($item->name)));
	}
}
?>
