<?php
/**
* The VisualComposerExtensionShortcodeBase class.
*
...
class VisualComposerExtensionShortcodeBase
{
	/**
	...
	protected function get_image_size($value, array $white_list = array('milenia-grid--cols-2', 'milenia-grid--cols-3', 'milenia-grid--cols-4'))
	{
		return in_array($value, $white_list) ? 'entity-thumb-size-rectangle' : 'entity-thumb-standard';
	}
	 ...
	 * @return string
	 */
	public static function getShortcodeUniqueId($string_id)
	{
