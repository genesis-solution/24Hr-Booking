...
class EddLicenseApi {
	...
	const OPTION_KEY    = 'mphb_checkout_fields_edd_license_key';
	const OPTION_STATUS = 'mphb_checkout_fields_edd_license_status';

	const PRODUCT_ID = 905135;
	...
	public function request( $eddAction ) {
		...
		$requestUrl = add_query_arg( $requestArgs, Plugin::getInstance()->getPluginSourceServerUrl() );
